 ...
 */
export const createDefaultConfig = (websiteId: string, walletAddress: string, apiBaseUrl?: string, overrides?: Partial<MantleAdsConfig>): MantleAdsConfig => {
  return {
    websiteId,
    walletAddress,
 ...
 */
export const validateConfig = (config: MantleAdsConfig): MantleAdsError[] => {
  const errors: MantleAdsError[] = [];
 ...
 */
export const formatPrice = (price: string, currency: string = 'MNT'): string => {
...
export const generateCheckoutUrl = (
  ...
  apiBaseUrl: string = 'https://mantleads.io',
 ...
 */
export const parseSlotConfigFromUrl = (): Partial<MantleAdsConfig> => {
  if (typeof window === 'undefined') return {};
  
  const params = new URLSearchParams(window.location.search);
  const config: Partial<MantleAdsConfig> = {};
