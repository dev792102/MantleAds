...
// Create the context
const MantleAdsContext = createContext(null);
// Provider component
export const MantleAdsProvider = ({ config, children }) => {
    ...
    if (error) {
        return (_jsxs("div", { style: {
                ...
                fontSize: '14px',
                color: '#c00'
            }, children: [_jsx("strong", { children: "MantleAds Configuration Error:" }), " ", error.message] }));
    }
    return (_jsx(MantleAdsContext.Provider, { value: contextValue, children: children }));
};
// Hook to use the context
export const useMantleAdsContext = () => {
...
export const useMantleAdsConfig = () => {
    const { config } = useMantleAdsContext();
    return config;
};
// Hook to get API base URL
export const useMantleAdsApi = () => {
