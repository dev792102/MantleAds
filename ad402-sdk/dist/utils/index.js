 ...
 */
export const createDefaultConfig = (websiteId, walletAddress, apiBaseUrl, overrides) => {
    return {
        websiteId,
        walletAddress,
        apiBaseUrl: apiBaseUrl || 'https://mantleads.io', // Allow custom API URL
        theme: {
            primaryColor: '#000000',
 ...
 */
export const formatPrice = (price, currency = 'MNT') => {
 ...
 */
export const generateCheckoutUrl = (slotId, price, size, websiteId, walletAddress, apiBaseUrl = 'https://mantleads.io', additionalParams) => {
 ...
 * Generate upload URL
 */
export const generateUploadUrl = (slotId, price, size, websiteId, walletAddress, apiBaseUrl = 'https://mantleads.io', additionalParams) => {
    const params = new URLSearchParams({
        slotId,
        price,
        size,
 ...
 */
export const fetchAdData = async (slotId, apiBaseUrl = 'https://mantleads.io') => {
 ...
 */
export const fetchQueueInfo = async (slotId, apiBaseUrl = 'https://mantleads.io') => {
...
export const trackAdEvent = (event, slotId, websiteId, additionalData) => {
    ...
    fetch('https://mantleads.io/api/analytics', {
        method: 'POST',
        headers: {
